...
Write-Host ""
Write-Host "[1/3] Building all 29 userland ELF programs..." -ForegroundColor Yellow
...
$UserlandBins = @(
    ...
    # Guest-isolation probes. See docs/guest-isolation.md
    "probe_descriptors", "probe_msr", "probe_portio", "probe_leaked"
)
